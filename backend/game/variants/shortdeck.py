...
class ShortdeckVariant(BaseVariant):
    """
    Shortdeck Hold'em — 36-card deck (2-5 removed).
    ...
    def get_hand_rankings(self) -> list[HandRank]:
        """Return hand ranks from best to worst (shortdeck order: flush > full house)."""
        return [
